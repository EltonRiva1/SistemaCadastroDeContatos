...
public class StringHelper {
    ...
    /**
     * Metodo remove caracters especiais (acentos, pontuações e etc.) de uma
     * string;
     *
     * @since 12/12/2010
     * </br> 1.0
    ...
    /**
     * Adiciona o caractere informado para a direita do texto até completar o
     * tamanho informado.
     *
     * @param text
     * @param character
    ...
    /**
     * Adiciona o caractere informado para a esquera do texto até completar o
     * tamanho informado.
     *
     * @param text
     * @param character
    ...
    /**
     * Verifica se uma string é nula e/ou vazia. O useTrim remove os espaçõs do
     * inico e do final.
     *
     * @since 12/12/2010
     * </br> 1.0
